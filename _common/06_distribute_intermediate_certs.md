...
- **Microsoft Windows**: Intermediate CA certificate distribution is _recommended_, but **optional**.
     - Windows clients are able to dynamically build paths to a trusted root CA certificate through Microsoft's Certificate Chaining Engine (CCE).  
     ...
     - Review common problems and solutions in our [Troubleshooting]({{site.baseurl}}/common/troubleshooting/) section.
